...
- **A made thing at the center, not an aesthetic.** TigerBeetle has pixel art, Bun has
  ...
  column.
- **Warmth undercutting seriousness.** Serious machinery (fifteen agent CLIs, git
...
- **Proof in the hero, not poetry.** Stats and running software over adjectives.
  "15 agent CLIs · 100% local · $0 forever" leads; superlatives never do.
...
- Numbers stay honest: "15 coding-agent CLIs," never "unlimited agents."
