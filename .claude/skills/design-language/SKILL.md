...
- **A made thing at the center, not an aesthetic.** TigerBeetle has pixel art, Bun has
  ...
  column.
- **Warmth undercutting seriousness.** Serious machinery (fourteen agent CLIs, git
...
- **Proof in the hero, not poetry.** Stats and running software over adjectives.
  "14 agent CLIs · 100% local · $0 forever" leads; superlatives never do.
...
- Numbers stay honest: "14 coding-agent CLIs," never "unlimited agents."
