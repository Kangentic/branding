...
at 24-26px. Full rationale, geometry, and decision history:
...
- **`resources/web/`** - favicon.ico + PNG favicons (F4k), apple-touch +
  manifest squares (opaque cream), JSON-LD `logo.png`, both brandmark SVGs
- **`resources/desktop/`** - Electron set: `icon.ico` (16-256),
  `icon.icns` (16-1024), the full PNG ladder; tiers mixed per entry
